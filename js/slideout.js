...
Slideout.prototype._translateXTo = function(translateX) {
  ...
  this.onTranslate && this.onTranslate(prefix + 'transform', 'translate3d(' + translateX + 'px, 0, 0)', true);
...
Slideout.prototype._setTransition = function() {
  this.onTransition && this.onTransition(prefix + 'transition', prefix + 'transform ' + this._duration + 'ms ' + this._fx);
...
Slideout.prototype._initTouchEvents = function() {
  ...
  this.panel.addEventListener(touch.move, function(eve) {
    ...
    if (Math.abs(dif_x) > 20) {
      ...
      self.onTranslate && self.onTranslate(prefix + 'transform', 'translate3d(' + translateX + 'px, 0, 0)');
